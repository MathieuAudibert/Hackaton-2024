...
<body>
    ...
    <div class="login-container">
        ...
        <form action="#" method="post">
            <input class="username-form"type="text" name="username" placeholder="Nom d'utilisateur" required><br>
            <input class="password-form" type="password" name="password" placeholder="Mot de passe" required><br>
